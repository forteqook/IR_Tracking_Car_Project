...
OBJECTS += Actuator/Motor.o
OBJECTS += Actuator/Servo.o
OBJECTS += Plotting/Plotting.o
OBJECTS += Sensor/DistanceSensor.o
OBJECTS += Sensor/HallSensor.o
OBJECTS += Sensor/LaneSensor.o
OBJECTS += main.o
...
INCLUDE_PATHS += -I../Actuator
INCLUDE_PATHS += -I../Plotting
INCLUDE_PATHS += -I../Sensor
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1661072301.0067873
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1661072301.0067873
...
ASM_FLAGS += -I../Actuator
ASM_FLAGS += -I../Plotting
ASM_FLAGS += -I../Sensor
ASM_FLAGS += -I../mbed
...
ASM_FLAGS += -include
ASM_FLAGS += /filer/workspace_data/exports/5/5a38b342e1cc25b79e0a3158e8a1625f/Mecha_Project/mbed_config.h
ASM_FLAGS += -c
ASM_FLAGS += -x
ASM_FLAGS += assembler-with-cpp
ASM_FLAGS += -Wall
